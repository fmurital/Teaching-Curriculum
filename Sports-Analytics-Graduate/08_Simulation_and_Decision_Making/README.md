...
**Scheduled:** Week 12 (see `00_Course_Admin/Course_Blueprint.md` for the full weekly schedule)
**Level:** Graduate

## Overview

Simulation-based and game-theoretic approaches to sports decision support.
